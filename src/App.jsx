...
function BottleRow({ bottle, onEdit }) {
  ...
  return (
    <li>
      <button
        onClick={onEdit}
        className="w-full text-left px-4 sm:px-5 py-4 hover:bg-stone-50 active:bg-stone-100 transition-colors block"
      >
        ...
        <div className="text-[13px] leading-5 mt-1 truncate">
          {subParts.length > 0 ? (
            subParts.map((part, i) => (
              <span key={part.key}>
