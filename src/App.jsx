  ...
  return (
    <div className="min-h-screen">
      <header
        ...
        style={{
          background: `
            radial-gradient(ellipse 90% 70% at 22% 28%, rgba(251, 191, 36, 0.22) 0%, transparent 55%),
            radial-gradient(ellipse 110% 70% at 80% 75%, rgba(146, 64, 14, 0.48) 0%, transparent 60%),
            radial-gradient(ellipse 70% 40% at 50% 108%, rgba(41, 13, 1, 0.7) 0%, transparent 70%),
            linear-gradient(180deg, #2a1407 0%, #1a0a04 55%, #0c0402 100%)
          `,
        }}
      >
        <div
          ...
          style={{
            background: `
              radial-gradient(ellipse 50% 35% at 30% 40%, rgba(255, 200, 100, 0.35) 0%, transparent 65%),
              radial-gradient(ellipse 35% 25% at 75% 65%, rgba(217, 119, 6, 0.25) 0%, transparent 70%)
            `
          }}
        />
        ...
        <button
          ...
          aria-label="Menu"
          className="absolute z-10 p-2 rounded-md transition-colors hover:bg-amber-950/40"
          style={{
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-6 py-12 relative">
          <h1 className="font-display text-4xl md:text-5xl tracking-tight font-bold text-amber-50">Inventory</h1>
          <div className="mt-3 text-sm num" style={{ color: 'rgba(254, 243, 199, 0.6)' }}>
            {counts.total === 0 ? (
              'No bottles yet'
            ) : (
              <>
                <span className="font-semibold text-amber-50">{counts.sealed}</span> bottles
                <span className="mx-1.5" style={{ color: 'rgba(254, 243, 199, 0.3)' }}>·</span>
      ...
      <div
        ...
        style={{
          background: `linear-gradient(to bottom,
            #0c0402 0,
            #0c0402 env(safe-area-inset-top),
            rgba(244, 239, 230, 0.97) env(safe-area-inset-top),
