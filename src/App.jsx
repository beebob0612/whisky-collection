    ...
    <div className="min-h-screen">
      <header className="bg-stone-900 text-stone-50 relative overflow-hidden pt-safe">
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-6 py-10 relative">
          ...
          <div className="text-stone-400 mt-2 text-sm num">
            {counts.total === 0 ? (
              'No bottles yet'
            ) : (
              <>
                <span className="text-stone-200 font-medium">{counts.sealed}</span> bottles
                <span className="text-stone-600 mx-1.5">·</span>
                <span className="text-stone-200 font-medium">{counts.opened}</span> opened
                <span className="text-stone-600 mx-1.5">·</span>
                <span className="text-stone-200 font-medium">{counts.finished}</span> finished
              </>
            )}
          </div>
        </div>
